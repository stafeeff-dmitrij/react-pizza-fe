		...
		<div className={cn('container', styles['cart'])}>
			{cartFull && <>
				<div className={styles['header']}>
					...
					<button className={styles['cart-clear']} onClick={() => alert('Корзина очищена')}>
						<svg
				...
				<div className={styles['products']}>
					...
					<div className={styles['product']}>
						...
						<div className={styles['count']}>
							...
							<b className={styles['product-count']}>2</b>
				...
				<div className={styles['footer']}>
					<div className={styles['result']}>
						<span className={styles['count']}>Всего пицц: <b>3 шт.</b></span>
						<span className={styles['price']}>Сумма заказа: <b>900 ₽</b></span>
					</div>
